...
class PodcastScriptGeneratorOSS:
    def __init__(self, ollama_url: str = "http://localhost:11434", model_name: str = "llama3.2"):
        self.ollama_url = ollama_url
        self.model_name = model_name
        logger.info(f"Podcast script generator initialized with Ollama model: {model_name}")
    ...
    def generate_script_from_text(
        ...
        logger.info("Generating podcast script from text input using Ollama")
...
Generate an engaging {target_duration} podcast script now:"""
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"Could not parse Ollama response as valid JSON: {response}")
